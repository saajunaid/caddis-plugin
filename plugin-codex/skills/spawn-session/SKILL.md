...
```bash
python "${CADDIS_PLUGIN_ROOT}/scripts/caddis_spawn.py" capture-check --id <id>
```
...
```bash
python "${CADDIS_PLUGIN_ROOT}/scripts/caddis_spawn.py" preflight
python "${CADDIS_PLUGIN_ROOT}/scripts/caddis_spawn.py" fingerprint --with-tests
```
...
```bash
python "${CADDIS_PLUGIN_ROOT}/scripts/caddis_spawn.py" preflight --context-pct 72
```
...
```bash
python "${CADDIS_PLUGIN_ROOT}/scripts/caddis_inventory.py" --with-tests
```
...
```bash
python "${CADDIS_PLUGIN_ROOT}/scripts/caddis_spawn.py" check --doc .caddis/spawn-session/<id>-prompt.md
```
...
```bash
python "${CADDIS_PLUGIN_ROOT}/scripts/caddis_spawn.py" verify-question \
...
```bash
python "${CADDIS_PLUGIN_ROOT}/scripts/caddis_spawn.py" handshake open --id <id>
```
...
```bash
python "${CADDIS_PLUGIN_ROOT}/scripts/caddis_spawn.py" handshake status --id <id>
```
...
```
python "${CADDIS_PLUGIN_ROOT}/scripts/caddis_spawn.py" handshake record --id <id> --event verdict --verdict REJECT
```
