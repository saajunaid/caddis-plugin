...
# /install-statusline — set up the status bar
...
- `${CADDIS_PLUGIN_ROOT}/scripts/caddis_statusline.py`
- `claude-harness/scripts/caddis_statusline.py` (working inside the caddis source repo)

Then:

```bash
python "${CADDIS_PLUGIN_ROOT}/scripts/caddis_statusline.py" --install          # both hosts
python "${CADDIS_PLUGIN_ROOT}/scripts/caddis_statusline.py" --install --host claude
python "${CADDIS_PLUGIN_ROOT}/scripts/caddis_statusline.py" --install --host agy
python "${CADDIS_PLUGIN_ROOT}/scripts/caddis_statusline.py" --install --dry-run # print, write nothing
```
