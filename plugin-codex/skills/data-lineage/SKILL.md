...
3. **Convert to Confluence Storage Format XHTML:**
   - Run the PlantUML-enabled converter:
     ```powershell
     python "${CADDIS_PLUGIN_ROOT}/scripts/convert_doc_to_confluence.py" docs/<app>/<app>-data-lineage.md --output docs/<app>/<app>-data-lineage.html --diagram-type plantuml
     ```
