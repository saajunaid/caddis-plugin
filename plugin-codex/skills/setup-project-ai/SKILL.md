...
- Plugin install: `${CADDIS_PLUGIN_ROOT}/scripts/setup_project_ai.py`
...
```
Resolve `<path-to>` per the same plugin-vs-source rule as the generator itself (`${CADDIS_PLUGIN_ROOT}`
